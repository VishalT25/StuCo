...
class SupabaseService: ObservableObject {
    ...
    /// True while the initial session check is in progress. UI should show a splash/loading state instead of the sign-in screen.
    ...
    private func initializeServices() async {
        ...
        await MainActor.run { self.isCheckingAuth = false }
