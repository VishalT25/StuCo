...
struct ModernEditMeetingSheet: View {
    ...
    init(meeting: CourseMeeting, courseName: String, courseColor: Color, isRotatingSchedule: Bool, onSave: @escaping (CourseMeeting) -> Void) {
        ...
        _selectedRotationDay = State(initialValue: meeting.rotationIndex)
    ...
    private func saveChanges() {
        ...
        if isRotatingSchedule {
            updatedMeeting.isRotating = true
            updatedMeeting.rotationIndex = selectedRotationDay
            updatedMeeting.rotationLabel = rotationLabel
            updatedMeeting.daysOfWeek = []
        } else {
            updatedMeeting.isRotating = false
            updatedMeeting.rotationIndex = nil
            updatedMeeting.rotationLabel = nil
